...
public class ClientesPages extends Configuracao {

    public static WebElement selectMake (WebDriver browser) {
        return browser.findElement(By.cssSelector("#make>option:nth-child(14)"));
    }

    public static WebElement selectModel (WebDriver browser) {
        return browser.findElement(By.cssSelector("#model>option:nth-child(2)"));
    }

    public static WebElement inputCylender (WebDriver browser) {
        return browser.findElement(By.cssSelector("#cylindercapacity"));
    }

    public static WebElement inputEngine (WebDriver browser) {
        return browser.findElement(By.cssSelector("#engineperformance"));
    }

    public static WebElement buttonCalendario (WebDriver browser) {
    ...
    public static WebElement inputPayload (WebDriver browser) {
        return browser.findElement(By.cssSelector("#payload"));
    }

    public static WebElement inputWeight (WebDriver browser) {
        return browser.findElement(By.cssSelector("#totalweight"));
    }

    public static WebElement inputPrice (WebDriver browser) {
        return browser.findElement(By.cssSelector("#listprice"));
    }

    public static WebElement inputLicense (WebDriver browser) {
        return browser.findElement(By.cssSelector("#licenseplatenumber"));
    }
    
    public static WebElement inputMileage (WebDriver browser) {
